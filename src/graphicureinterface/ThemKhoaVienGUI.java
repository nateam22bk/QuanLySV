...
public class ThemKhoaVienGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtSoTCMax = new javax.swing.JTextField();
        txtSoTCTC = new javax.swing.JTextField();
        ...
        jLabel6.setText("Số TC Max : ");

        jLabel7.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel7.setText("Số TC TC : ");

        txtSoTCMax.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N

        txtSoTCTC.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(txtSoTCMax)
                    .addComponent(txtSoTCTC))
                .addContainerGap(27, Short.MAX_VALUE))
        );

        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {txtMaVien, txtSoTCMax, txtSoTCTC, txtSoTCTN, txtTenVien});
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel6)
                    .addComponent(txtSoTCMax, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 11, Short.MAX_VALUE)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7)
                    .addComponent(txtSoTCTC, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(20, 20, 20))
        );
    ...
    void themKhoaVien(){
        ...
        String soTCTNStr = txtSoTCTN.getText().trim();
        String soTCTCStr = txtSoTCTC.getText().trim();
        String soTCMaxStr = txtSoTCMax.getText().trim();
        Integer soTCTN = 0;
        Integer soTCMax = 0;
        Integer soTCTC = 0;
        
        try {
            soTCTN = Integer.parseInt(soTCTNStr);
            soTCTC = Integer.parseInt(soTCTCStr);
            soTCMax = Integer.parseInt(soTCMaxStr);
            if (maVien.length() < 2){
                throw new Exception();
            }
            if (tenVien.length() < 5){
        ...
        KhoaVien khoaVien = new KhoaVien(maVien, tenVien, new ArrayList<SinhVien>(), new ArrayList<LopHoc>(), new ArrayList<>(), soTCMax, soTCTC, soTCTN);
    ...
    private javax.swing.JTextField txtSoTCMax;
    private javax.swing.JTextField txtSoTCTC;
