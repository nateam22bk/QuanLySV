...
public class DangKiHocGUI extends javax.swing.JFrame {
    ...
    public void initTable() {
        ...
        defaultTableModelTraCuu = new DefaultTableModel();
            ...
            defaultTableModelMonHocDK.addColumn("Tự chọn");
            ...
            defaultTableModelTraCuu.addColumn("Tự chọn");
    ...
    public void showDataTraCuu() {
        ...
        for (MonHoc monHoc : listMonHoc) {
            if (monHoc instanceof MonTinChi) {
                ...
                data.add(String.valueOf(monHoc.getLaMonTuChon()));
    ...
    public void dangKiMonHoc() {
        ...
        ArrayList<Vector<String>> listMHDK = new ArrayList<>();
        listMHDK = getListMH();

        for (Vector<String> MHDK : listMHDK) {
            for (int i = 0; i < listKhoaVien.get(kvIndex).getDsMonHoc().size(); i++) {
                if (listKhoaVien.get(kvIndex).getDsMonHoc().get(i).getMaMon().equals(MHDK.get(0))) {
                    if (listKhoaVien.get(kvIndex).getDsMonHoc().get(i) instanceof MonTinChi) {
                        listKhoaVien.get(kvIndex).getDsMonHoc().get(i).setLaMonTuChon(Integer.parseInt(MHDK.get(3)));
    ...
    public ArrayList<Vector<String>> getListMH() {
        ArrayList<Vector<String>> MHDangKi = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        checkBoxTuChon = new javax.swing.JCheckBox();
        ...
        checkBoxTuChon.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        checkBoxTuChon.setForeground(new java.awt.Color(255, 0, 0));
        checkBoxTuChon.setText("Tự chọn tự do");
